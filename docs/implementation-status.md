...
| Raw Composite ML-DSA (draft revision 19) | implemented and measured | `results/draft-composite-2026-07/draft-composite-100k.*` | Sign/Verify, domain separation, context binding, and raw concatenation are implemented; independent interoperability remains open. |
