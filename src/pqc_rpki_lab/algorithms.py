...
COMPOSITE_ESTIMATES = (
    ...
    Algorithm("P-256+ML-DSA-44", "Composite", "hybrid", 1377, 2492, "confirmed-raw",
              "draft-ietf-lamps-pq-composite-sigs-19", "OpenSSL EVP Draft-19 implementation",
              "Measured raw Draft-19 concatenation; no local X.509/CMS interoperability evidence.",
              track="composite-candidate", comparison_required=False),
    Algorithm("RSA-2048+ML-DSA-65", "Composite", "hybrid", 2222, 3565, "estimated",
              "draft-ietf-lamps-pq-composite-sigs", "size model only",
              "Component-size sum excluding composite ASN.1 overhead; no local X.509/CMS interoperability evidence.",
              track="composite-candidate", comparison_required=False),
    Algorithm("P-256+ML-DSA-65", "Composite", "hybrid", 2017, 3381, "confirmed-raw",
              "draft-ietf-lamps-pq-composite-sigs-19", "OpenSSL EVP Draft-19 implementation",
              "Measured raw Draft-19 concatenation; no local X.509/CMS interoperability evidence.",
              track="composite-candidate", comparison_required=False),
    Algorithm("RSA-2048+ML-DSA-87", "Composite", "hybrid", 2862, 4883, "estimated",
              "draft-ietf-lamps-pq-composite-sigs", "size model only",
              "Component-size sum excluding composite ASN.1 overhead; no local X.509/CMS interoperability evidence.",
              track="composite-candidate", comparison_required=False),
    Algorithm("P-384+ML-DSA-87", "Composite", "hybrid", 2689, 4731, "confirmed-raw",
              "draft-ietf-lamps-pq-composite-sigs-19", "OpenSSL EVP Draft-19 implementation",
              "Draft-19 defines P-384, not P-256, for this ML-DSA-87 combination; no local X.509/CMS interoperability evidence.",
              track="composite-candidate", comparison_required=False),
