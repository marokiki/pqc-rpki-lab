...
"$PYTHON" "$ROOT/tools/ccr_comparison.py"
"$PYTHON" "$ROOT/tools/object_benchmarks.py"
"$PYTHON" "$ROOT/tools/mixed_tree_fixture.py"
"$PYTHON" "$ROOT/tools/cms_api_probe.py"
"$PYTHON" "$ROOT/tools/generate_rpki_objects.py"
"$PYTHON" "$ROOT/tools/key_roll_benchmark.py"
"$PYTHON" "$ROOT/tools/local_object_validation.py"
"$PYTHON" "$ROOT/tools/routinator_krill_scan.py"
"$PYTHON" "$ROOT/tools/routinator_krill_interop.py"
...
"$PYTHON" "$ROOT/tools/pre_publication_check.py"
